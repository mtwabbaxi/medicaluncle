    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 col-sm-12 col-12">
                <div class="cv-heading text-left">
                    <h1>New Arrivals</h1>
                </div>
            </div>
                    ...
                    <div class="cv-gallery-grid">
                        <div class="cv-product-box cv-product-item cv-hand">
                            ...
                            <div class="cv-product-data">
                                <a href="javascript:;" class="cv-price-title">Sphygmomanometer</a>
                        ...
                        <div class="cv-product-box cv-product-item cv-face cv-body">
                            <div class="cv-product-img">
                                <img src="nassets/images/product02.jpg" alt="image" class="img-fluid"/>
                                <div class="cv-product-button">
                                    <a href="product-single.html" class="cv-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                                        <g>
                                            <path d="M230.656,156.416c-40.96,0-74.24,33.28-74.24,74.24s33.28,74.24,74.24,74.24s74.24-33.28,74.24-74.24
                            ...
                            <div class="cv-product-data">
                                <a href="javascript:;" class="cv-price-title">Thermometer</a>
                        ...
                        <div class="cv-product-box cv-product-item cv-face">
                            <div class="cv-product-img">
                                <img src="nassets/images/product04.jpg" alt="image" class="img-fluid"/>
                                <div class="cv-product-button">
                                    <a href="product-single.html" class="cv-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                                        <g>
                                            <path d="M230.656,156.416c-40.96,0-74.24,33.28-74.24,74.24s33.28,74.24,74.24,74.24s74.24-33.28,74.24-74.24
                            ...
                            <div class="cv-product-data">
                                <a href="javascript:;" class="cv-price-title">Glass Mask</a>
                        ...
                        <div class="cv-product-box cv-product-item cv-face cv-body">
                            <div class="cv-product-img">
                                ...
                                <img src="nassets/images/product05.jpg" alt="image" class="img-fluid"/>
                                <div class="cv-product-button">
                                    <a href="product-single.html" class="cv-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                                        <g>
                                            <path d="M230.656,156.416c-40.96,0-74.24,33.28-74.24,74.24s33.28,74.24,74.24,74.24s74.24-33.28,74.24-74.24
                            ...
                            <div class="cv-product-data">
                                <a href="javascript:;" class="cv-price-title">Gloves</a>
                        ...
                        <div class="cv-product-box cv-product-item cv-face">
                            <div class="cv-product-img">
                                <img src="nassets/images/product06.jpg" alt="image" class="img-fluid"/>
                                <div class="cv-product-button">
                                    <a href="product-single.html" class="cv-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                                        <g>
                                            <path d="M230.656,156.416c-40.96,0-74.24,33.28-74.24,74.24s33.28,74.24,74.24,74.24s74.24-33.28,74.24-74.24
                            ...
                            <div class="cv-product-data">
                                <a href="javascript:;" class="cv-price-title">Digital Stethoscope</a>
                        ...
                        <div class="cv-product-box cv-product-item cv-face">
                            <div class="cv-product-img">
                                <span class="cv-sale">sale</span>
                                <img src="nassets/images/product07.jpg" alt="image" class="img-fluid"/>
                                <div class="cv-product-button">
                                    <a href="product-single.html" class="cv-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                                        <g>
                                            <path d="M230.656,156.416c-40.96,0-74.24,33.28-74.24,74.24s33.28,74.24,74.24,74.24s74.24-33.28,74.24-74.24
                        ...
                        <div class="cv-product-box cv-product-item cv-hand">
                            <div class="cv-product-img">
                                <span class="cv-sale">sale</span>
                                <img src="nassets/images/product08.jpg" alt="image" class="img-fluid"/>
                                <div class="cv-product-button">
                                    <a href="product-single.html" class="cv-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                                        <g>
                                            <path d="M230.656,156.416c-40.96,0-74.24,33.28-74.24,74.24s33.28,74.24,74.24,74.24s74.24-33.28,74.24-74.24
                            ...
                            <div class="cv-product-data">
                                <a href="javascript:;" class="cv-price-title">Surgical Glove</a>
                                <p class="cv-pdoduct-price"><del>$70</del> $65</p>
                                <p><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i></p>
                            </div>
                        </div>
                        <div class="cv-product-box cv-product-item cv-face cv-body">
                            <div class="cv-product-img">
                                <span class="cv-sale">sale</span>
                                <img src="nassets/images/product03.jpg" alt="image" class="img-fluid"/>
                                <div class="cv-product-button">
                                    <a href="product-single.html" class="cv-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.312 461.312">
                                        <g>
                                            <path d="M230.656,156.416c-40.96,0-74.24,33.28-74.24,74.24s33.28,74.24,74.24,74.24s74.24-33.28,74.24-74.24
